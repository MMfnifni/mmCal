...
- Repaired missing `</ItemGroup>` closures in `mmCal.Core.vcxproj` and `.vcxproj.filters`, then validated every `.vcxproj` / `.filters` file with an XML parser; Visual Studio project loading works again.
