...
def compare_arrays(file1, file2, eps=1e-15):
    ...
    print("Loaded: " + file2)
    print(f"Load time: {load_end - start:.6f}[s]")
    ...
    energy_rel_err = energy_err / max(abs(energy_a), eps)
    ...
    print("Energy Relative Error    :", energy_rel_err)

    end = time.perf_counter()
    print(f"\nTotal elapsed time: {end - start:.6f} [s]")
    print("===================================")
    ...
    return {
        ...
        "energy_rel_err": float(energy_rel_err),
    }
