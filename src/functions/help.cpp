...
namespace mm::cal {
 ...
 static const std::unordered_map<std::string, std::string> kFunctionHelp = {
     ...
     // ---- trig ----
     {                      "sin",                                                                                           "sin[x]: sine. Returns an angle in the current angle mode."},
     {                      "cos",                                                                                         "cos[x]: cosine. Returns an angle in the current angle mode."},
     {                      "tan",                                                                                        "tan[x]: tangent. Returns an angle in the current angle mode."},
     {                      "cot",                                                                                      "cot[x]: cotangent. Returns an angle in the current angle mode."},
     {                      "sec",                                                                                         "sec[x]: secant. Returns an angle in the current angle mode."},
     {                      "csc",                                                                                       "csc[x]: cosecant. Returns an angle in the current angle mode."},
     {                     "asin",                                                                                  "asin[x]: inverse sine. Returns an angle in the current angle mode."},
     {                     "acos",                                                                                "acos[x]: inverse cosine. Returns an angle in the current angle mode."},
     {                     "atan",                                                                               "atan[x]: inverse tangent. Returns an angle in the current angle mode."},
     {                    "atan2",                                                            "atan2[y, x]: quadrant-aware inverse tangent. Returns an angle in the current angle mode."},
     ...
     {                     "zeta",                                                                                                 "zeta[s]: Riemann zeta function for s > 0 && s != 1."},
     ...
     // ---- signal ----
     {                     "sinc",       "sinc[x]: normalized sinc = sin[r]/r, where x is interpreted in the current angle mode and r is the internal radian angle. Returns 1 at x = 0."},
     {                     "cosc",       "cosc[x]: normalized cosc = cos[r]/r, where x is interpreted in the current angle mode and r is the internal radian angle. Returns 1 at x = 0."},
     {                     "tanc",       "tanc[x]: normalized tanc = tan[r]/r, where x is interpreted in the current angle mode and r is the internal radian angle. Returns 1 at x = 0."},
     ...
     {                   "vangle",                                                                                           "vangle[a, b]: Returns an angle in the current angle mode."},
     ...
     {                "covmatrix",                        "covmatrix[v1, v2, ...]: sample covariance matrix of sample vectors v1, v2, ... . All vectors must have the same length >= 2."},
     {               "corrmatrix", "corrmatrix[v1, v2, ...]: sample correlation matrix of sample vectors v1, v2, ... . All vectors must have the same length >= 2 and nonzero variance."},
     {                 "convolve",                                         "convolve[x, y]: discrete linear convolution of vectors x and y. Returns a vector of length len(x)+len(y)-1."},
     ...
     {               "meigenvals",                                                                                              "meigenvals[A]: eigenvalues of a symmetric real matrix."},
     {               "meigenvecs",                                                                                             "meigenvecs[A]: eigenvectors of a symmetric real matrix."},
     ...
     {          "mmaxeigen_power",                                                       "mmaxeigen_power[A]: dominant eigenvalue estimate for a symmetric real matrix by power method."},
     {                "mmaxeigen",                                                                                        "mmaxeigen[A]: largest eigenvalue of a symmetric real matrix."},
     ...
     {                      "arg",                                                                         "arg[z]: argument / phase angle. Returns an angle in the current angle mode."},
     {                     "conj",                                                                                                                         "conj[z]: complex conjugate."},
     {                    "polar",                                                   "polar[r, th]: construct a complex number from magnitude r and angle th in the current angle mode."},
     {                     "rect",                                                                                                                        "rect[r, th]: alias of polar."},
     {                      "cis",                     "cis[th]: cos(r) + i sin(r), where th is interpreted in the current angle mode and r is the corresponding internal radian angle."},
