...
constexpr BuiltinSpec defaultBuiltins[] = {
    ...
    fixed(builtins::names::toNormal, BuiltinId::ToNormal, 1,
        ArgumentEvaluation::All, true),
    ...
    range(builtins::names::round, BuiltinId::Round, 1, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::frac, BuiltinId::Frac, 1, ArgumentEvaluation::All, true),
    variadic(builtins::names::bitAnd, BuiltinId::BitAnd, 2, ArgumentEvaluation::All, true),
    variadic(builtins::names::bitOr, BuiltinId::BitOr, 2, ArgumentEvaluation::All, true),
    variadic(builtins::names::bitXor, BuiltinId::BitXor, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitNot, BuiltinId::BitNot, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitShiftLeft, BuiltinId::BitShiftLeft, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitShiftRight, BuiltinId::BitShiftRight, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitLength, BuiltinId::BitLength, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitCount, BuiltinId::BitCount, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::bitGet, BuiltinId::BitGet, 2, ArgumentEvaluation::All, true),
    ...
    fixed(builtins::names::isPrime, BuiltinId::IsPrime, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::nextPrime, BuiltinId::NextPrime, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::previousPrime, BuiltinId::PreviousPrime, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::factorInteger, BuiltinId::FactorInteger, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::totient, BuiltinId::Totient, 1, ArgumentEvaluation::All, true),
    ...
    fixed(builtins::names::fma, BuiltinId::Fma, 3, ArgumentEvaluation::All, true),
    fixed(builtins::names::clamp, BuiltinId::Clamp, 3, ArgumentEvaluation::All, true),
    fixed(builtins::names::proj, BuiltinId::Proj, 1, ArgumentEvaluation::All, true),
    ...
    range(builtins::names::vectorAngle, BuiltinId::VectorAngle, 2, 3, ArgumentEvaluation::All, true),
    ...
    fixed(builtins::names::vectorInner, BuiltinId::VectorInner, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::vectorOuter, BuiltinId::VectorOuter, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::vectorRejection, BuiltinId::VectorRejection, 2, ArgumentEvaluation::All, true),
    fixed(builtins::names::orthogonalQ, BuiltinId::OrthogonalQ, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::orthonormalQ, BuiltinId::OrthonormalQ, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::linearIndependentQ, BuiltinId::LinearIndependentQ, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::gramSchmidt, BuiltinId::GramSchmidt, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::gradient, BuiltinId::Gradient, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::divergence, BuiltinId::Divergence, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::curl, BuiltinId::Curl, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::laplacian, BuiltinId::Laplacian, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::jacobian, BuiltinId::Jacobian, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::hessian, BuiltinId::Hessian, 2, ArgumentEvaluation::HoldAll, true),
    fixed(builtins::names::directionalDerivative, BuiltinId::DirectionalDerivative, 3, ArgumentEvaluation::HoldAll, true),
    ...
    fixed(builtins::names::exponentialIntegralEi, BuiltinId::ExponentialIntegralEi, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::sineIntegralSi, BuiltinId::SineIntegralSi, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::cosineIntegralCi, BuiltinId::CosineIntegralCi, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::logarithmicIntegralLi, BuiltinId::LogarithmicIntegralLi, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::polylog, BuiltinId::Polylog, 2, ArgumentEvaluation::All, true),
    ...
    fixed(builtins::names::zeta, BuiltinId::Zeta, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::digamma, BuiltinId::Digamma, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::trigamma, BuiltinId::Trigamma, 1, ArgumentEvaluation::All, true),
    fixed(builtins::names::incompleteBeta, BuiltinId::IncompleteBeta, 3, ArgumentEvaluation::All, true),
