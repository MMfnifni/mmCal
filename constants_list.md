...
- Values are fundamentally unified in SI (MKS) units (`m`, `kg`, `s`, `K`, `A`, `mol`, `cd`), Angles are displayed in radians,
  but note that this calculator defaults to degrees.
...
## 単位変換テーブル / Unit Conversion Table

- `convert`関数用である。`convert(10,"mm","cm")=1`であり，`convert(10,"mm")=0.01`である。
- For the `convert` function. `convert(10,“mm”,‘cm’)=1`, and `convert(10,“mm”)=0.01`.

| 単位系 / Unit-system  | 単位 / Unit | 倍率 (基準単位) / Mag. |
| --------------------- | ----------- | ---------------------- |
| length                | m           | 1.0                    |
|                       | mm          | 0.001                  |
|                       | cm          | 0.01                   |
...
|                       | C           | 1.0                    |
|                       | F           | 1.0                    |
| electric_current      | A           | 1.0                    |
|                       | mA          | 0.001                  |
|                       | µA          | 1e-6                   |
|                       | nA          | 1e-9                   |
| amount_of_substance   | mol         | 1.0                    |
|                       | mmol        | 0.001                  |
|                       | µmol        | 1e-6                   |
| luminous_intensity    | cd          | 1.0                    |
|                       | mcd         | 0.001                  |
| area                  | m2          | 1.0                    |
|                       | cm2         | 0.0001                 |
|                       | mm2         | 1e-6                   |
...
|                       | hp          | 745.7                  |
|                       | cv          | 735.499                |
| electric_charge       | C           | 1.0                    |
|                       | mC          | 0.001                  |
|                       | µC          | 1e-6                   |
|                       | nC          | 1e-9                   |
| electric_potential    | V           | 1.0                    |
|                       | kV          | 1000.0                 |
|                       | mV          | 0.001                  |
| electric_capacitance  | F           | 1.0                    |
|                       | µF          | 1e-6                   |
|                       | nF          | 1e-9                   |
|                       | pF          | 1e-12                  |
| electric_resistance   | Ω           | 1.0                    |
|                       | kΩ          | 1000.0                 |
|                       | MΩ          | 1000000.0              |
| electric_conductance  | S           | 1.0                    |
|                       | mS          | 0.001                  |
|                       | µS          | 1e-6                   |
| magnetic_flux         | Wb          | 1.0                    |
|                       | mWb         | 0.001                  |
|                       | µWb         | 1e-6                   |
| magnetic_flux_density | T           | 1.0                    |
|                       | mT          | 0.001                  |
|                       | µT          | 1e-6                   |
| frequency             | Hz          | 1.0                    |
|                       | kHz         | 1000.0                 |
